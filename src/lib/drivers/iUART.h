...
#define UART_IIR_NONE 						BIT(0)
#define UART_IIR_RECEIVER_STATUS 	BIT(1) | BIT(2)
#define UART_IIR_RECEIVED_DATA 		BIT(2)
#define UART_IIR_FIFO_TIMEOUT 		BIT(2) | BIT(3)
#define UART_IIR_MODEM 						0
#define UART_IIR_64BITFIFO				BIT(5)
#define UART_IIR_IS_FIFO_ENABLED	BIT(6) | BIT(7)
