 ...
 *
 * This function draws the various elements of the game based on the current state stored in the app structure.
 * 
 ...
 *
 * This function first checks if a redraw is necessary. If it is, it draws the background, the current game state,
 ...
 *
 * This function iterates over the queue of buttons and draws each button at the specified position on the screen.
 * 
